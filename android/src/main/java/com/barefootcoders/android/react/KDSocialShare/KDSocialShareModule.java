...
public class ReactNativeSocialKitModule extends ReactContextBaseJavaModule {
  ReactApplicationContext reactContext;

  public ReactNativeSocialKitModule(ReactApplicationContext reactContext) {
    super(reactContext);
